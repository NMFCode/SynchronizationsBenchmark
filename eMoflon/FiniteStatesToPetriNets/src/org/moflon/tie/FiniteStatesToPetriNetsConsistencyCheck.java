...
public class FiniteStatesToPetriNetsConsistencyCheck extends SynchronizationHelper{

   public FiniteStatesToPetriNetsConsistencyCheck()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        FiniteStatesToPetriNetsConsistencyCheck helper = new FiniteStatesToPetriNetsConsistencyCheck();
