...
public class FiniteStatesToPetriNetsModelGen extends SynchronizationHelper{

   public FiniteStatesToPetriNetsModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(FiniteStatesToPetriNetsPackage.eINSTANCE, controller);
		gen.generate();
	}
}